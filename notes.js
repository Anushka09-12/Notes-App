...
function showNotes() {
  ...
  notesObj.forEach(function(element, index) {
    html += `
            <div class="noteCard my-2 mx-2 card" style="width: 18rem; border: 2px solid rgb(54, 19, 19);">
                    <div class="card-body">
  ...
  if (notesObj.length != 0) {
    ...
    notesElm.innerHTML = `<strong>Nothing to show! Use "Add Note" section beside to add notes.</strong>`;
  }
}
